    ...
    <div class='c-head'>
        <div class='container'>
            ...
            <div class='head-right'>
                ...
                <div v-else>
                    <el-button @click='showLogin(true)' class='head-right-btn' type='primary'>登录</el-button>
                    <el-button @click='showLogin(false)' class='head-right-btn' type='primary'>注册</el-button>
                </div>

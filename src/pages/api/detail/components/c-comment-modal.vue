<template>
    <div>
        <c-modal :is-custom='true' :is-show-modal='isShowModal' :is-show-title='false' width='1200px'>
            <div slot='custom'>
                <div class='comment-container'>
                    ...
                    <div class='comment-bottom xy-center'>
                        ...
                        <c-star :edit='true' :star='5' class='c-comment-star' />

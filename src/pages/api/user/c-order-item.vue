<template>
    <div class='c-order-item'>
        <div :class="orderItem.paymentState === 'SUCCESSED' ? '' : 'components-blue-header'" class='order-header'>
                ...
                <el-col :span='8' class='order-right'>
                    <div ref='right'>
                        <el-row class='order-right-row'>
                            <el-col :class="orderItem.paymentState === 'SUCCESSED' ? '' : 'components-col-blue-item'"
                                    :span='12'
        ...
        <c-modal :context="'是否删除该订单？'" :is-show-cancel='true' :is-show-modal='isShowDel' @confirm='deleteOrder'
